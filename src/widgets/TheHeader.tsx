export default function TheHeader() {
    return(
        <header
            className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#264532] px-10 py-3">
            <div className="flex items-center gap-4 text-white">
                ...
                <h2 className="text-white text-lg font-bold leading-tight tracking-[-0.015em]">Vlasenko Roman</h2>
            </div>
            <div className="flex flex-1 justify-end gap-8">
                <div className="flex items-center gap-9">
                    <a className="text-white text-sm font-medium leading-normal" href="About">About</a>
                    <a className="text-white text-sm font-medium leading-normal" href="Projects">Portfolio</a>
